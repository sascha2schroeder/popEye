...
PlotBoundary <- function(exp, subject, trial, pdf = F, interactive = F,
                         cex = 1) {
  ...
  # plots
  PlotBoundaryX(exp, subject, trial, sub = T, cex = cex)
  PlotBoundaryTime(exp, subject, trial, sub = T, cex = cex)
